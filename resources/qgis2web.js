...
var map = new ol.Map({
    ...
    view: new ol.View({
         maxZoom: 28, minZoom: 1, projection: new ol.proj.Projection({
            code: '',
            //extent: [2645803.726102, 709418.796039, 2855436.950502, 921773.879539],
            units: 'm'})
    })
});

//initial view - epsg:3857 coordinates if not "Match project CRS"
map.getView().fit([2533996.571912, 774915.010991, 2777941.585127, 933574.031795], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">Población que habla lengua índigena en el Estado de México</h2>';
        return titleElement;
    })(),
